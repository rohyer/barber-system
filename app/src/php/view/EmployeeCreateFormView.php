...
<body>
  ...
  <div class="general__content">
    <div class="general__top">
      <h1 class="general__title">Cadastrar Colaborador</h1>
    </div>

    <form action="cadastro" method="post" class="form__form" id="client-form">
      ...
      <div class="form__input-field">
        ...
        <span class="form__error"><?php echo isset($result["sex"]) ? $result["sex"] : ""; ?></span>
      </div>
      ...
      <div class="form__input-field">
        ...
        <div class="bar"></div>
        <span class="form__error"><?php echo isset($result["address"]) ? $result["address"] : ""; ?></span>
      </div>
      ...
      <div class="form__input-field">
        ...
        <span class="form__error"><?php echo isset($result["birth"]) ? $result["birth"] : ""; ?></span>
      </div>
      ...
      <div class="form__input-field">
        ...
        <div class="bar"></div>
        <span class="form__error"><?php echo isset($result["phone"]) ? $result["phone"] : ""; ?></span>
      </div>
